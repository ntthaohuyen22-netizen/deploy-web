...
{
    public class ToolProductCreateDtoValidator : AbstractValidator<ToolProductCreateDto>
    {
        public ToolProductCreateDtoValidator()
        {
            RuleFor(x => x.Name)
    ...
    public class ToolProductUpdateDtoValidator : AbstractValidator<ToolProductUpdateDto>
    {
        public ToolProductUpdateDtoValidator()
        {
            RuleFor(x => x.Id)
