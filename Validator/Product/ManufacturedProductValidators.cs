...
{
    public class ManufacturedProductCreateDtoValidator : AbstractValidator<ManufacturedProductCreateDto>
    {
        public ManufacturedProductCreateDtoValidator()
        {
            RuleFor(x => x.Name)
    ...
    public class ManufacturedProductUpdateDtoValidator : AbstractValidator<ManufacturedProductUpdateDto>
    {
        public ManufacturedProductUpdateDtoValidator()
        {
            RuleFor(x => x.Id)
